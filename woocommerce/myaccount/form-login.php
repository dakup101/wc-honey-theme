...
<section class="account-login py-5">
    <div class="container">
        <?php do_action('woocommerce_before_customer_login_form'); ?>

        <?php if ('yes' === get_option('woocommerce_enable_myaccount_registration')) : ?>
        <div class="row mt-5">
            <div class="col-10 account-login__wrapper-big offset-1 col-md-8 offset-md-2">
                <div class="row">
                    <div class="col-md-3 account-login__bg-col"
                         style="background-image: url('<?php echo get_template_directory_uri() . '/assets/images/intersect.jpg' ?>')">
